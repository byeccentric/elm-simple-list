...
var $author$project$Data$spendList = _List_fromArray(
	[
		{cat: 3, date: '01.06.2021', name: 'taxi', sum: 512, sum_plus: 550},
		{cat: 2, date: '01.06.2021', name: 'предоплата за Орел', sum: 3000, sum_plus: 3000},
		{cat: 7, date: '01.06.2021', name: 'vk combo', sum: 149, sum_plus: 150},
		{cat: 7, date: '01.06.2021', name: 'покупка домена', sum: 200, sum_plus: 200},
		{cat: 4, date: '02.06.2021', name: 'сигареты стики', sum: 276.99, sum_plus: 300},
		{cat: 7, date: '02.06.2021', name: 'продукты', sum: 281.16, sum_plus: 300},
		{cat: 3, date: '03.06.2021', name: 'taxi', sum: 519, sum_plus: 550},
		{cat: 4, date: '03.06.2021', name: 'стики', sum: 1449.99, sum_plus: 1500},
		{cat: 3, date: '04.06.2021', name: 'taxi', sum: 520, sum_plus: 550},
		{cat: 3, date: '04.06.2021', name: 'taxi', sum: 528, sum_plus: 550},
		{cat: 7, date: '05.06.2021', name: 'перекус в икеи', sum: 230, sum_plus: 250},
		{cat: 0, date: '05.06.2021', name: 'матрас и одеяло', sum: 17652, sum_plus: 17700},
		{cat: 4, date: '06.06.2021', name: 'сигареты', sum: 132, sum_plus: 150},
		{cat: 7, date: '06.06.2021', name: 'продукты', sum: 228.97, sum_plus: 250},
		{cat: 7, date: '06.06.2021', name: 'продукты', sum: 240, sum_plus: 250},
		{cat: 7, date: '06.06.2021', name: 'подписка кс', sum: 360.28, sum_plus: 400},
		{cat: 7, date: '06.06.2021', name: 'продукты', sum: 221.23, sum_plus: 221.23},
		{cat: 3, date: '07.06.2021', name: 'такси', sum: 499, sum_plus: 500},
		{cat: 8, date: '07.06.2021', name: 'продукты Маша', sum: 705.79, sum_plus: 750},
		{cat: 3, date: '07.06.2021', name: 'на тройку', sum: 500, sum_plus: 500},
		{cat: 3, date: '08.06.2021', name: 'такси', sum: 560, sum_plus: 600},
		{cat: 7, date: '08.06.2021', name: 'кофе', sum: 150, sum_plus: 150},
		{cat: 7, date: '08.06.2021', name: 'delivery KFC', sum: 988, sum_plus: 1000},
		{cat: 8, date: '08.06.2021', name: 'продукты', sum: 380.94, sum_plus: 400},
		{cat: 5, date: '10.06.2021', name: 'маме на джинсы', sum: 3000, sum_plus: 3000},
		{cat: 8, date: '10.06.2021', name: 'продукты', sum: 282.6, sum_plus: 300},
		{cat: 3, date: '11.06.2021', name: 'такси', sum: 554, sum_plus: 600},
		{cat: 8, date: '12.06.2021', name: 'продукты', sum: 1657.97, sum_plus: 1700},
		{cat: 7, date: '13.06.2021', name: 'фрукты', sum: 985, sum_plus: 1000},
		{cat: 7, date: '13.06.2021', name: 'фрукты', sum: 18.76, sum_plus: 50},
		{cat: 4, date: '13.06.2021', name: 'сигареты', sum: 384.56, sum_plus: 400},
		{cat: 4, date: '13.06.2021', name: 'сигареты', sum: 452, sum_plus: 500},
		{cat: 8, date: '13.06.2021', name: 'доставка на 20 дней', sum: 23175, sum_plus: 23200},
		{cat: 8, date: '13.06.2021', name: 'возврат от Маши части', sum: -20000, sum_plus: -20000},
		{cat: 6, date: '14.06.2021', name: 'интернет', sum: 450, sum_plus: 450},
		{cat: 8, date: '14.06.2021', name: 'стики', sum: 3000, sum_plus: 3000},
		{cat: 8, date: '14.06.2021', name: 'продукты', sum: 834.25, sum_plus: 850},
		{cat: 3, date: '14.06.2021', name: 'проезд', sum: 1, sum_plus: 50},
...
var $author$project$Data$maximums = $elm$core$Array$fromList(
	_List_fromArray(
		[15000, 20000, 12500, 10000, 5000, 5000, 45000, 5000, 0]));
...
var $author$project$Data$getCategoryMaximum = function (cat) {
	return A2(
...
var $author$project$Spend$renderCategories = function (data) {
	...
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$tr, _List_Nil, renderValues),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Data$getCategory(spend.cat))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$elm$core$String$fromFloat(spend.sum) + (' (' + ($elm$core$String$fromFloat(spend.sum_plus) + ')')))
					])),
				A2(
				$elm$html$Html$td,
				_List_Nil,
...
var $author$project$Spend$spends = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('На текущий месяц категории')
				])),
			A2(
			$elm$html$Html$table,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Список трат за месяц')
				])),
			A2(
			$elm$html$Html$table,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$attribute, 'border', '1'),
					A2($elm$html$Html$Attributes$attribute, 'width', '30%')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Сумма (полная)')
										])),
									A2(
									$elm$html$Html$th,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('Комментарий')
										]))
								]))
						])),
...
var $author$project$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Общее положение')
				])),
			A2(
			$elm$html$Html$table,
			_List_fromArray(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Инвест счет')
										])),
									A2(
									$elm$html$Html$th,
									_List_Nil,
									_List_fromArray(
										[
											$elm$html$Html$text('Инвест копилка')
										])),
									A2(
									$elm$html$Html$th,
									_List_Nil,
									...
									_List_fromArray(
										[
											$elm$html$Html$text('На путешествия')
										]))
								]))
						])),
					A2(
